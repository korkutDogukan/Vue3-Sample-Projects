  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-2">
        ...
        <button @click="changeText" class="btn btn-primary m-4">Tersi</button>
      </div>
    </div>
  </div>
</template>
...
const changeText = () => {
  const unChangeText1 = selectedElement.value;
  const unChangeText2 = selectedElement2.value;

  selectedElement.value = unChangeText2;
  selectedElement2.value = unChangeText1;
};
</script>
